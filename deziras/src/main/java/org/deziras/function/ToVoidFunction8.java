 ...
 */
@FunctionalInterface
public interface ToVoidFunction8<T1, T2, T3, T4, T5, T6, T7, T8>
        extends CheckedToVoidFunction8<T1, T2, T3, T4, T5, T6, T7, T8> {
    ...
    default Function8<T1, T2, T3, T4, T5, T6, T7, T8, Unit> boxed() {
