 ...
 */
@FunctionalInterface
public interface ToVoidFunction9<T1, T2, T3, T4, T5, T6, T7, T8, T9>
        extends CheckedToVoidFunction9<T1, T2, T3, T4, T5, T6, T7, T8, T9> {
    ...
    default Function9<T1, T2, T3, T4, T5, T6, T7, T8, T9, Unit> boxed() {
